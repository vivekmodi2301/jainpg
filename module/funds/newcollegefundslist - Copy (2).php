...
//		print_r($courseArray);
	...
	// change by gopal
//	$rs=mysqli_query($con,"SELECT collegefunddte.cid as cid, dt, collegefunddte.scid,count(distinct sid) as total, coursename,year,sum(collegefunddte.fees) as gtotal FROM collegefunddte join courses on courses.id=collegefunddte.cid group by collegefunddte.cid");
	//end change
...
//	$frs=mysqli_query($con,"SELECT collegefunddte.id, sum(collegefunddte.fees) as fees, collegefunddte.cid, collegefunddte.scid as scid, dt,coursename,name,funds FROM collegefunddte join courses on courses.id=collegefunddte.cid join subcourse on collegefunddte.scid=subcourse.id where collegefunddte.cid=$data[cid]  group by  collegefunddte.funds");
	...
	echo "SELECT collegefunddte.id, sum(collegefunddte.fees) as fees, collegefunddte.cid, collegefunddte.scid as scid, dt,coursename,name,funds FROM collegefunddte join courses on courses.id=collegefunddte.cid join subcourse on collegefunddte.scid=subcourse.id join studentfees on studentfees.sid=collegefunddte.sid where extraFees='' and collegefunddte.cid=$data[cid]  group by  collegefunddte.funds";
